...
public class AbstractPageUI {
	...
	public static final String CUSTOMER_SERVICE_LINK_XPATH="//a[text()='Customer Service']";
	public static final String PRIVACY_POLICY_LINK_XPATH="//a[text()='Privacy Policy']";
	public static final String SITE_MAP_LINK_XPATH="//a[text()='Site Map']";
	public static final String SEARCH_TERM_LINK_XPATH="//a[text()='Search Terms']";
